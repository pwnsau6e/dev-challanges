...
Find it. Be fast. Submit the flag.

## 🏁 Scoring

This challenge is order-based.

Points are awarded depending on when a correct flag is submitted:

* 1st solve → 500 points
* 2nd solve → 400 points
* 3rd solve → 300 points
* 4th solve → 200 points
* Any later solve → 100 points

## 📌 Notes

* This is a bonus challenge
* Speed is part of the challenge
* The environment may change as person solve
* Not everything here is noise

No further information will be provided.

## 🔍 Rules

The rules will be revealed when you find the solution.